    ...
    document.addEventListener('DOMContentLoaded', function () { 
        setTimeout(function () {
            ...
            if (window.innerWidth > 991) {
                ...
                var leftArrowPosition = document.getElementsByClassName("forLineBg")[0].getBoundingClientRect().left + document.getElementsByClassName("forLineBg")[0].offsetWidth / 2 - document.getElementsByClassName("after")[0].offsetWidth / 2 - parseInt(window.getComputedStyle(document.querySelector('.after'), ':before').width) / 2 + "px";
                ...
                var leftArrowPosition = document.getElementsByClassName("forLineBg")[0].getBoundingClientRect().left + document.getElementsByClassName("forLineBg")[0].offsetWidth / 2 - document.getElementsByClassName("after")[0].offsetWidth / 2 + "px";
                document.getElementsByClassName("after")[0].style.left = leftArrowPosition;
                document.getElementsByClassName("before")[0].style.left = leftArrowPosition;
            }
    ...
    if (fb || twitter || linkedin || hangout || mailto) {
        if (fb[i]) {
            ...
            function chngImgColorfb() {
                this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/color/FB.svg)";
            }
            fb[i].addEventListener("mouseleave", chngImgfb);

            function chngImgfb() {
                this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/FB.svg)";
            }
        }
        if (twitter[i]) {
            ...
            function chngImgColortwitter() {
                this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/color/twitter_icon.svg)";
            }
            twitter[i].addEventListener("mouseleave", chngImgtwitter);

            function chngImgtwitter() {
                this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/twitter_icon.svg)";
            }
        }
        if (linkedin[i]) {
            ...
            function chngImgColorlinkedin() {
                this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/color/LinkedIn.svg)";
            }
            linkedin[i].addEventListener("mouseleave", chngImglinkedin);

            function chngImglinkedin() {
                this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/Linkedin.svg)";
            }
        }
        // if (hangout[i]) {
        ...
        //         this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/color/G+Yellow.svg)";
        //     }
        //     hangout[i].addEventListener("mouseleave", chngImghangout);

        //     function chngImghangout() {
        //         this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/G+white.svg)";
        //     }
        // }
        if (mailto[i]) {
            ...
            function chngImgColormailto() {
                this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/color/Contact_Us.svg)";
            }
            mailto[i].addEventListener("mouseleave", chngImgmailto);

            function chngImgmailto() {
                this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/pages/heritage/shareOptions/Contact_Us.svg)";
            }
        }
